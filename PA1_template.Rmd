...
```r
## Strategy for filling in all of the missing values in the dataset. To fill in the missing values, mean steps for a five-minute interval for the entire dataset is used.
value1 <- sqldf('  
    SELECT d.*, i.mean
